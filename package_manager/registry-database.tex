...
\txtl{package}, \txtl{package_dependency}, \txtl{package_versions}. The last
two tables both have foreign keys referencing the \txtl{package} table. The
...
The \txtl{origin} field which appears in all three tables reference the origin
